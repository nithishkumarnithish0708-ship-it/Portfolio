(function ($) {
	...
	var ramsay_portfolio = {
		...
		initializ: function () {
			ramsay_portfolio.styleSwitcher();
			ramsay_portfolio.onePageFunction();
			ramsay_portfolio.mobile_menu();
			ramsay_portfolio.commonActivation();
			ramsay_portfolio.portfolio_isotop();
			ramsay_portfolio.sticky_menu();
			ramsay_portfolio.scroll_to_top();
			ramsay_portfolio.background_image();
			ramsay_portfolio.circleProgressbar();
			ramsay_portfolio.site_carousel();
			ramsay_portfolio.portfolioPopup();
			ramsay_portfolio.calendarHolder();
		},
	};
	$(function () {
		ramsay_portfolio.initializ();
